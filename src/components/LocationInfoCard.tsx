	...
	return (
		<div className="flex w-full flex-col gap-[16px]">
			...
			<div className="flex w-full flex-col gap-[8px]">
				<p className="font-['Geist_Mono'] text-[10px] leading-none font-semibold tracking-[-0.2px] text-[#7c868e] uppercase">
					{label}
				</p>
...
export default function LocationInfoCard({ location }: Props) {
	return (
		<div className="flex w-[min(361px,calc(100vw-2rem))] flex-col gap-[24px] rounded-[36px] border border-[#e6eaed] bg-white p-[24px] shadow-xl">
