...
export const normalizeTriplet = (r: number, g: number, b: number): [number, number, number] => {
...
export const toRgb = (
	...
	if (typeof value === 'string') {
		...
		const parsed = trimmed.startsWith('#') ? parseHexColor(trimmed) : parseCssColor(trimmed);
