	...
	function renderMarkerTooltip({ marker }: GlobeMarkerTooltipContext) {
		...
		return (
			<div className="flex flex-col items-center gap-4">
				...
				<div
					className={cn(
						'relative flex shrink-0 items-center gap-2.5 rounded-[9000px] border px-2.5 py-2 text-xs leading-none font-medium whitespace-nowrap shadow-lg transition-[background-color,color,border-color,box-shadow,transform] duration-300 hover:scale-105 active:scale-95 hover:shadow-[0_6px_16px_-4px_rgba(0,0,0,0.18)]',
						focused
